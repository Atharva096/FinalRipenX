...
# This is the root project directory (Final-BE-Project)
...
# ✅ UPDATED: RF models now point to backend folder
RF_MODEL_PATH = BACKEND_DIR / "random_forest_harvest.joblib"
RF_COLUMNS_PATH = BACKEND_DIR / "rf_feature_columns.joblib"
